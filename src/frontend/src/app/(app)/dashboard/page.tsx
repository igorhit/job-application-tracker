  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">Visão geral das suas candidaturas</p>
      </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            {data.upcomingActions.map(action => (
              ...
              >
                <div>
                  <p className="font-medium text-gray-900 text-sm">{action.jobTitle}</p>
                  <p className="text-xs text-gray-500">{action.companyName}</p>
                  {action.nextActionNote && (
                    <p className="mt-1 text-xs text-gray-600">{action.nextActionNote}</p>
                  )}
                </div>
